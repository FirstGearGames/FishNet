...
namespace FishNet.Managing.Server
{
    public partial class ServerManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Returns the ArraySegment for message generated by writer.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="writer"></param>
        /// <param name="message"></param>
        /// <returns></returns>
        private ArraySegment<byte> GetBroadcastArraySegment<T>(PooledWriter writer, T message)
        {
            writer.WriteByte((byte)PacketId.Broadcast);
            writer.WriteUInt16(typeof(T).FullName.GetStableHash16());
