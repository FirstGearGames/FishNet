...
namespace Fishnet.NetworkProfiler.ModuleGUI.Messages
{
    internal sealed class MessageViewController : ProfilerModuleViewController
    {
        ...
        private bool TryGetMessages(int frameIndex, out List<PacketInfo> messages)
        {
        ...
        private static List<PacketInfo> GenerateDebugMessages()
        {
            var messages = new List<PacketInfo>();
            var order = 0;
//            for (var i = 0; i < 5; i++)
//            {
